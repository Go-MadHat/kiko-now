...
![]({{ site.baseurl }}/images/mitny/misc/tjctf_horse.png)
...
![]({{ site.baseurl }}/images/mitny/misc/tjctf_leg.png)
...
![]({{ site.baseurl }}/images/mitny/misc/tjctf_flag.png)
...
![]({{ site.baseurl }}/images/mitny/misc/skeleton_apk.png)

다운로드 받은 파일의 압축을 해제하면 apk 파일이 보인다. 

![]({{ site.baseurl }}/images/mitny/misc/skeleton_svg.png)

apk를 zip으로 바꿔서 보면 파일의 내부를 볼 수 있고, assets 폴더에 logo.svg가 있었다.

![]({{ site.baseurl }}/images/mitny/misc/skeleton_logo.png)

logo.svg를 열면 해골이 보인다. 
svg 파일을 편집하기 위해 Inkspace를 사용했다. 일러스트레이터도 있지만 깔기가 귀찮았다..ㅎㅎ

![]({{ site.baseurl }}/images/mitny/misc/skeleton_dot.png)

해골의 눈 코,입을 분해하다보니 광대 밑쪽에 작은 점이 보였다.
이 부분을 돋보기 기능으로 쭉 확대하면 플래그가 있다!

![]({{ site.baseurl }}/images/mitny/misc/skeleton_flag.png)
<br><br>
...
![]({{ site.baseurl }}/images/mitny/misc/message_k1.png)

![]({{ site.baseurl }}/images/mitny/misc/message_k2.png)


LOR M I SUM 의 빈 칸은 `LOREM IPSUM(로렘 입숨)` 라는 단어로 완성된다.

![]({{ site.baseurl }}/images/mitny/misc/loremipsum.png)
...
![]({{ site.baseurl }}/images/mitny/misc/message_result.png)
