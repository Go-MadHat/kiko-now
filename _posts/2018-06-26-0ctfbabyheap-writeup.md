...
```  
>>>>>>> 3afa7b7c6a98a34bf4a3d0197f5c4e2f8b70086c
pwndbg> checksec
...
```  
[chaem이랑 짚고가기]
unsorted bin : small 또는 large chunk는 각각의 bin에서 해제되는 경우, unsorted bin에 추가된다.  
최근에 해제된 청크를 재사용할 수 있도록 하기위해서 이다.  
따라서, 적절한 bin을 찾는데 걸리는 시간이 적기 때문에 메모리 할당과 반납의 비트 처리 속도가 빠르다.  
```  
>>>>>>> 3afa7b7c6a98a34bf4a3d0197f5c4e2f8b70086c
