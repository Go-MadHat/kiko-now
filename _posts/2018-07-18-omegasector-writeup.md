...
![]({{ site.baseurl }}/images/mingzzi/omegasector-writeup/omega_01.PNG)
...
![]({{ site.baseurl }}/images/mingzzi/omegasector-writeup/omega_02.PNG)

![]({{ site.baseurl }}/images/mingzzi/omegasector-writeup/omega_03.PNG)
...
![]({{ site.baseurl }}/images/mingzzi/omegasector-writeup/omega_04.PNG)

![]({{ site.baseurl }}/images/mingzzi/omegasector-writeup/omega_05.PNG)

* omega_sector.php

![]({{ site.baseurl }}/images/mingzzi/omegasector-writeup/omega_06.PNG)

![]({{ site.baseurl }}/images/mingzzi/omegasector-writeup/omega_07.PNG)
...
![]({{ site.baseurl }}/images/mingzzi/omegasector-writeup/omega_08.PNG)

![]({{ site.baseurl }}/images/mingzzi/omegasector-writeup/omega_09.PNG)

![]({{ site.baseurl }}/images/mingzzi/omegasector-writeup/omega_10.PNG)

* omega_sector.php

![]({{ site.baseurl }}/images/mingzzi/omegasector-writeup/omega_11.PNG)

![]({{ site.baseurl }}/images/mingzzi/omegasector-writeup/omega_12.PNG)

![]({{ site.baseurl }}/images/mingzzi/omegasector-writeup/omega_13.PNG)
...
![]({{ site.baseurl }}/images/mingzzi/omegasector-writeup/omega_14.PNG)

코드를 보기 좋게 정리하면 다음과 같다.  

![]({{ site.baseurl }}/images/mingzzi/omegasector-writeup/omega_15.PNG)

![]({{ site.baseurl }}/images/mingzzi/omegasector-writeup/omega_16.PNG)
...
![]({{ site.baseurl }}/images/mingzzi/omegasector-writeup/omega_17.PNG)

![]({{ site.baseurl }}/images/mingzzi/omegasector-writeup/omega_18.PNG)

이 후 생성된 파일에 직접 접근하며, `?_=system&__=ls`를 쿼리스트링으로 넘겨주었다.  

![]({{ site.baseurl }}/images/mingzzi/omegasector-writeup/omega_19.PNG)

그 결과, 아래와 같이 `ls` 명령어가 실행된 것을 확인할 수 있었다.  

![]({{ site.baseurl }}/images/mingzzi/omegasector-writeup/omega_20.PNG)
...
![]({{ site.baseurl }}/images/mingzzi/omegasector-writeup/omega_21.PNG)
